                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/regist" method="post">
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="">
                                <label for="nowa" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                                    WhatsApp no.</label>
                                <input type="number" min=0 name="nowa" id="nowa"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="628..." required=""
                                    value="@if(isset($data)){{$data->nowa}}@endif">
                            </div>
                            <div class="">
                                <label for="nik" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Your
                                    NIK</label>
                                <input type="number" min=0 name="nik" id="nik"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="34030..." required=""
                                    value="@if(isset($data)){{$data->nik}}@endif">
                            </div>
                            <div class="">
                                <label for="password"
